...
for(const host of ['codex','claude']) {
  ...
  const common={name,version:host==='claude'?'0.1.1':'0.1.0',description:'Personal and project memory across your agents.',author:{name:'Satchel'},repository:'https://github.com/NeerajG03/satchel'};

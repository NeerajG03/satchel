...
| [Memory v2 build plan](memory-v2-build.md) | What exactly has to be built for it, what do Claude Code and Codex each actually support, and what did the retrieval probes prove? |

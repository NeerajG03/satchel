...
- Entry provenance: handle {name} · {kind} · said {n} times · picked up automatically · revision {n}
- Entry actions: Correct · Read more info (only when there is any) · See what you said (picked-up memories) · Hide

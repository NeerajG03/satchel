  ...
  <section class="frame" style="width:640px; flex:none; border-radius:0; padding:14px; box-shadow:none;">
    <main class="paper" style="flex-grow:1; padding:52px 60px 40px; justify-content:space-between;">
      ...
      <div class="col" style="gap:16px;">
        ...
        <p class="muted" style="margin:0; font-size:16px; max-width:420px;">Only the scopes you just allowed. Change or revoke them any time in Apps.</p>
      </div>
      <div class="between"><a href="Apps.dc.html" class="btn primary">Back to Apps</a><span class="prov">neerajg03 · 17 Sep</span></div>
    </main>
  </section>
  <section style="width:640px; flex:none; background:${rightBg}; color:${rightInk}; font-family:${rightFont}; padding:66px 74px 54px; display:flex; flex-direction:column; justify-content:space-between;">
    ${rightMark}
    <div style="display:flex; flex-direction:column; gap:16px;">
      <span style="font-size:12px; letter-spacing:.08em; text-transform:uppercase; color:${rightMuted};">Connection complete</span>
      <h2 style="font-family:${rightFont}; font-size:44px; line-height:1.1; font-weight:400; letter-spacing:-.02em; margin:0; color:${rightInk};">Satchel is connected to ${app}.</h2>
      <p style="margin:0; font-size:16px; line-height:1.55; color:${rightMuted}; max-width:420px;">Your next conversation starts with your memory index already loaded. You can close this tab.</p>
    </div>
    <div style="display:flex; justify-content:space-between; align-items:center;"><a href="#" style="display:inline-flex; align-items:center; min-height:44px; padding:0 20px; border-radius:999px; background:${rightAccent}; color:${rightBg}; font-weight:500; font-size:14px; text-decoration:none;">Return to ${app}</a><span style="font-size:11px; letter-spacing:.06em; text-transform:uppercase; color:${rightMuted};">${note}</span></div>
  </section>
...
const connectedClaude = connected({ partner: 'Claude', app: 'Claude Code', rightBg: '#FAF9F5', rightInk: '#141413', rightMuted: '#6E6A62', rightAccent: '#D97757', rightFont: "'Newsreader', Georgia, serif", note: 'Anthropic ivory · slate · clay',
  rightMark: `<span style="font-family:'Newsreader',Georgia,serif; font-size:40px; letter-spacing:-.02em; color:#141413;">Claude</span>` });

const connectedCodex = connected({ partner: 'OpenAI', app: 'Codex', rightBg: '#000000', rightInk: '#FFFFFF', rightMuted: '#9A9A9A', rightAccent: '#FFFFFF', rightFont: "'Instrument Sans', system-ui, sans-serif", note: 'Black and white · no logo used',
  rightMark: `<span style="font-family:'Instrument Sans',sans-serif; font-weight:600; font-size:34px; letter-spacing:-.02em; color:#FFFFFF;">OpenAI</span>` });
